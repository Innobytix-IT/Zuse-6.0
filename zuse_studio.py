...
class ZuseEditorWidget(tk.Frame):
    """
    Ein erweitertes Editor-Widget mit Zeilennummern und Syntax-Highlighting.
    """
...
class ZuseStudio:
    def __init__(self, root):
        self.root = root
        self.root.title("Zuse Studio 6.4 - Dual Mode Edition")
        ...
        # NEU: Modus Umschalter (Profi / Lernen)
