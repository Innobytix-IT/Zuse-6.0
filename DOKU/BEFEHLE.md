...
## 6. Operatoren & Datenzugriff (Mathematik, Listen, Strings)
...
| `objekt.attribut` | Zugriff auf Methoden oder Variablen. | `pablo.gehe(10)` |
| `objekt[index]` | Zugriff auf Listen-Element oder Dictionary-Wert. | `liste[0]` oder `daten["a"]` |
| `objekt[start:ende]` | **Slicing (Ausschneiden)**: Schneidet Teile aus Listen oder Texten. | `text[0:3]` (die ersten 3) |
